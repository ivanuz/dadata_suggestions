...
AddressSuggestion _$AddressSuggestionFromJson(Map<String, dynamic> json) {
  return AddressSuggestion(
    ...
    data: json['data'] == null ? null : SuggestionData.fromJson(json['data'] as Map<String, dynamic>),
  );
}

Map<String, dynamic> _$AddressSuggestionToJson(AddressSuggestion instance) => <String, dynamic>{
